"""Reporting helpers for task evaluation LLM preprocessing."""
...
def render_task_eval_llm_preprocessing_report(
    *,
    ...
    lines = [
        f"# task evaluation LLM Preprocessing - {summary['run_id']}",
        "",
        ...
        f"- remaining_invalid_task_count: `{harness.get('remaining_invalid_task_count')}`",
        "",
