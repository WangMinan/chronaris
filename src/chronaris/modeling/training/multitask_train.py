"""Unified multitask training entry for the task evaluation thesis mainline."""
...
class StageIMultitaskTrainPipeline:
    ...
    def run(
        ...
        *,
        ...
        dump_task_eval_private_task_entries(task_entries, path=task_manifest_path)
...
def run_task_eval_multitask_train(
    config: StageIMultitaskTrainConfig,
    *,
    samples: tuple[E0ExperimentSample, ...],
    task_entries: Sequence[StageIPrivateTaskEntry],
