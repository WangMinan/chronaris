"""Reusable alignment-backbone training entry for the task evaluation thesis mainline."""
...
from chronaris.feature_export.export_helpers import resolve_export_scope
...
def run_task_eval_backbone_train(
    config: StageIBackboneTrainConfig,
    samples: tuple[E0ExperimentSample, ...],
    *,
    source_summary: Mapping[str, object] | None = None,
...
def collect_task_eval_backbone_samples(
    *,
    ...
    summary = _collect_task_eval_samples(
        profiles=profiles,
...
def collect_task_eval_multitask_samples(
    *,
    profiles: Sequence[StageHSortieProfile],
    window_config: WindowConfig,
    physiology_point_limit_per_measurement: int | None = None,
...
def _collect_task_eval_samples(
    *,
    profiles: Sequence[StageHSortieProfile],
    window_config: WindowConfig,
