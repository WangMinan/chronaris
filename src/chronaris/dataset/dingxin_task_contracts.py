"""Contracts and JSON helpers for task evaluation private-task benchmarks."""
...
class StageIPrivateTaskEntry:
    """One private-task sample derived from feature export all-window assets."""
...
def dump_task_eval_private_task_entries(
...
def load_task_eval_private_task_entries(path: str | Path) -> tuple[StageIPrivateTaskEntry, ...]:
    rows = [
        json.loads(line)
