"""NASA CSM adapter for task evaluation attention-state windows."""
...
class NASACSMPreparedTaskSet:
    """Prepared NASA CSM task evaluation entries."""
...
def build_nasa_csm_task_entries(dataset_root: str | Path) -> NASACSMPreparedTaskSet:
    """Build the NASA CSM task evaluation manifest from extracted CSV files."""
