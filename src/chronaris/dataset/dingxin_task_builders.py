"""Weak-label thesis-task builders over private feature export aligned records."""
...
from chronaris.evaluation.dingxin.pipelines.feature_utils import bucketize_score, none_if_empty
...
def build_task_eval_real_task_payload(records: pd.DataFrame) -> dict[str, object]:
    """Build thesis-facing weak-label tasks from aligned private feature export records."""

    if records.empty:
        raise ValueError("task evaluation thesis-task builders require at least one aligned record.")
