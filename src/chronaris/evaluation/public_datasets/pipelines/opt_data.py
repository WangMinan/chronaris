"""Feature-frame builders for task evaluation public-opt runs."""
...
def build_task_eval_public_opt_feature_frame(
    ...
    *,
    ...
    """Build one sample-level feature frame from prepared task evaluation sequence assets."""
