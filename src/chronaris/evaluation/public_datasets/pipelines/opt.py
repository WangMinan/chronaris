"""Public-opt runners for task evaluation UAB and NASA sequence assets."""
...
from chronaris.evaluation.public_datasets.pipelines.opt_reporting import (
    render_task_eval_public_opt_report,
)
from chronaris.evaluation.public_datasets.pipelines.opt_sklearn import (
...
def run_task_eval_public_opt(
    ...
    with open_task_eval_run_observer(
        ...
        stage_name="task_eval_public_opt_sklearn",
        logger=LOGGER,
        initial_progress={
        ...
        LOGGER.info(
            "task_eval_public_opt start run_id=%s dataset_id=%s prepared_root=%s",
            config.run_id,
        ...
        LOGGER.info(
            "task_eval_public_opt finished run_id=%s summary_path=%s report_path=%s",
            config.run_id,
            summary_path,
            report_path,
        )
