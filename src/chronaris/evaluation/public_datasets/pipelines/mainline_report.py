"""Unified public-mainline report builder for task evaluation."""
...
def run_task_eval_public_mainline_report(
    ...
    report_path = report_root / f"task-eval-public-mainline-{config.run_id}.md"
...
def _load_uab_candidate_payload(
    *,
    ...
    if "selected_result" in payload:
        groups = payload["selected_result"]["groups"]
...
def _render_public_mainline_report(summary: Mapping[str, object]) -> str:
    ...
    lines = [
        "# task evaluation Public Mainline Report",
        "",
