"""Deep baseline pipelines for task evaluation sequence experiments."""
...
from chronaris.features.sequence_features import STAGE_H_CASE_DATASET_ID
from chronaris.modeling.common.baseline_models import build_loso_splits
from chronaris.evaluation.public_datasets.pipelines.deep_baseline_case import (
    _run_real_sortie_case_study as _run_real_sortie_case_study_impl,
)
from chronaris.evaluation.public_datasets.pipelines.deep_baseline_reporting import (
...
def run_task_eval_deep_baseline(
    ...
    with open_task_eval_run_observer(
        ...
        stage_name="task_eval_deep_baseline",
        logger=LOGGER,
        initial_progress={
...
def run_task_eval_deep_comparison(
