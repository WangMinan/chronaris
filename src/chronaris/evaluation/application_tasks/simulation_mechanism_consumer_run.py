...
from chronaris.evaluation.application_tasks.simulation_mechanism_reporting import (
    write_simulation_mechanism_outputs,
)
...
def run_simulation_mechanism_consumers(
    ...
    with open_task_eval_run_observer(
        ...
        paths = write_simulation_mechanism_outputs(
