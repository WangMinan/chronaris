...
def run_pipeline_step(stage, config, *, attempt=1):
    ...
    if stage.startswith('stage5_'):
        from chronaris.evaluation.application_tasks.stage5 import run_stage5
        return run_stage5(stage, config)
    ...
    if stage.startswith('stage45_'):
        from chronaris.evaluation.application_tasks.stage45 import run_stage45
        return run_stage45(stage, config)
