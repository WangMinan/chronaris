"""Phase 2 case-study metrics over frozen feature export assets."""
...
from chronaris.features.case_study import StageICaseStudyViewInput, StageICaseStudyWindowRow
...
def compute_case_study_ablations(
    ...
    *,
    ...
    physiology_states = np.asarray(view.feature_export_view.physiology_reference_projection, dtype=np.float32)
    vehicle_states = np.asarray(view.feature_export_view.vehicle_reference_projection, dtype=np.float32)
    offsets = np.asarray(view.feature_export_view.reference_offsets_s, dtype=np.float32)
    ...
    *,
    ...
    return StageICaseStudyViewSummary(
        ...
        exported_hidden_fused_vs_projection_baseline_cosine=_mean_hidden_vs_projection_cosine(
            exported_fused=np.asarray(view.feature_export_view.fused_representation, dtype=np.float32),
