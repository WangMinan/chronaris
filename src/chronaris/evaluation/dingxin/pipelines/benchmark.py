"""Private-task benchmark pipeline over feature export all-window exports."""
...
from chronaris.dataset import build_task_eval_real_task_payload
from chronaris.dataset.dingxin_task_contracts import dump_task_eval_private_task_entries
...
from chronaris.evaluation.dingxin.pipelines.benchmark_models import (
    build_conclusion,
    json_default,
    run_task_suite,
    write_task_plots,
...
from chronaris.evaluation.dingxin.pipelines.optimized_package import (
...
def run_task_eval_private_benchmark(
    ...
    thesis_task_payload = build_task_eval_real_task_payload(records)
    ...
    dump_task_eval_private_task_entries(proxy_task_payload["entries"], path=task_manifest_path)
    dump_task_eval_private_task_entries(thesis_task_payload["entries"], path=thesis_task_manifest_path)
