...
from chronaris.evaluation.dingxin.pipelines.benchmark_reporting import (
    build_conclusion,
    is_better_classification,
    is_better_regression,
    is_better_retrieval,
    json_default,
    metrics_better_than_all,
    write_task_plots,
)
from chronaris.pipelines.torch_runtime import resolve_torch_device_name, seed_torch

if TYPE_CHECKING:  # pragma: no cover - typing only
    from chronaris.evaluation.dingxin.pipelines.benchmark import StageIPrivateBenchmarkConfig
...
def run_task_suite(
    *,
    ...
    """Run one layer of task evaluation private tasks over the current feature variants."""
...
def task_entry_to_sequence_entry(task_entry: StageIPrivateTaskEntry) -> StageISequenceEntry:
    return StageISequenceEntry(
        ...
        sequence_length=0,
        modality_schema={},
        source_origin="feature_export_private_benchmark",
