"""Optimized Chronaris candidate helpers for the private task evaluation benchmark."""
...
from chronaris.evaluation.dingxin.pipelines.feature_utils import safe_mean
    ...
    *,
    ...
    for position, frame_index in enumerate(indices):
        ...
        rows.append(
            {
                "sample_id": row["sample_id"],
                "dataset_id": "private_feature_export_benchmark",
