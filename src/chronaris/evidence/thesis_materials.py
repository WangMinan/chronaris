"""Build task evaluation thesis-facing tables and explanatory figures."""
...
from chronaris.evidence.thesis_materials_figures import (
    PlotFontSelection,
    detect_plot_font,
...
DEFAULT_EVIDENCE_MANIFEST_PATH = (
    "docs/artifacts/runs/2026-06-07_evidence-closure/"
    "evidence_manifest.json"
)
DEFAULT_PROXY_SWEEP_SUMMARY_PATH = (
    "docs/artifacts/runs/20260607T-task-eval-evidence-closure-r2-multitask/"
    "multitask_sweep_summary.json"
)
DEFAULT_LIVE_SWEEP_SUMMARY_PATH = (
    "docs/artifacts/runs/2026-06-13_dingxin-weak-label-sweep-resume/"
    "multitask_sweep_summary.json"
)
DEFAULT_LIVE_PARTIAL_SUMMARY_PATH = (
    "docs/artifacts/runs/2026-06-13_dingxin-weak-label-sweep-partial/"
    "partial_summary.json"
)
DEFAULT_PRIVATE_COMPONENT_SUMMARY_PATH = (
    "docs/artifacts/runs/2026-06-19_dingxin-leakage-safe-ablation/"
    "ablation_summary.json"
)
DEFAULT_PUBLIC_CALIBRATION_SUMMARY_PATH = (
    "docs/artifacts/runs/2026-06-07_public-adapter-calibration/"
    "public_adapter_calibration_summary.json"
)
DEFAULT_PUBLIC_TRANSFER_SUMMARY_PATH = (
    "docs/artifacts/runs/2026-06-07_public-transfer-boundary/"
...
DEFAULT_ROTATION_AUDIT_SUMMARY_PATH = (
    "docs/artifacts/runs/2026-06-19_rotation-audit-figure-refresh/"
    "rigid_body_rotation_audit_summary.json"
)
DEFAULT_RUNTIME_SUMMARY_PATH = (
    "docs/artifacts/runs/2026-06-07_runtime-inference-service/"
    "runtime_inference_summary.json"
)
DEFAULT_RUNTIME_SERVICE_SUMMARY_PATH = (
    "docs/artifacts/runs/2026-06-13_runtime-schema-contract/"
...
DEFAULT_RUNTIME_CASE_TABLE_PATH = (
    "docs/artifacts/runs/20260613T-task-eval-thesis-materials-r2-p18/"
    "runtime_semantic_case.csv"
)
DEFAULT_SUPPORT_SUMMARY_PATH = (
    "docs/artifacts/runs/2026-06-07_semantic-support/"
    "support_summary.json"
)
DEFAULT_SEMANTIC_EVENT_SUMMARY_PATH = (
    "docs/artifacts/runs/2026-06-07_semantic-event-support/"
    "semantic_event_support_summary.json"
)
DEFAULT_LLM_PREPROCESSING_SUMMARY_PATH = (
    "docs/artifacts/runs/2026-06-14_llm-preprocessing-context/"
    "llm_preprocessing_summary.json"
)
DEFAULT_LLM_COMPARISON_SUMMARY_PATH = (
    "docs/artifacts/runs/2026-06-14_llm-preprocessing-comparison/"
...
def run_task_eval_thesis_materials(
    ...
    with open_task_eval_run_observer(
        ...
        stage_name="task_eval_thesis_materials",
        logger=LOGGER,
        initial_progress={"artifact_root": str(run_root)},
    ) as progress:
        return _run_task_eval_thesis_materials_observed(
            config=config,
            run_root=run_root,
            progress=progress,
        )
...
def _run_task_eval_thesis_materials_observed(
    *,
    config: StageIThesisMaterialsConfig,
    run_root: Path,
    ...
    report_path = report_root / f"task-eval-thesis-materials-{config.run_id}.md"
    report_path.write_text(
        render_task_eval_thesis_materials_report(
            run_id=config.run_id,
            sources=sources,
            table_entries=table_entries,
...
def render_task_eval_thesis_materials_report(
    *,
    run_id: str,
    ...
    from chronaris.evidence.thesis_materials_report import (
        render_task_eval_thesis_materials_report as render_report,
    )
