"""task evaluation midterm evidence-pack builder."""
...
from chronaris.evidence.midterm_figures import (
    PlotFontSelection,
    _detect_plot_font,
    _write_figures,
)
from chronaris.evidence.midterm_metrics import (
...
DEFAULT_SUPPORT_SUMMARY_PATH = (
    "docs/artifacts/runs/20260506T120000Z-task-eval-support/"
...
DEFAULT_ANCHOR_MANIFEST_PATH = (
    "docs/artifacts/runs/20260506T165435Z-task-eval-anchor/"
...
DEFAULT_PUBLIC_FUSION_SCREEN_SUMMARY_PATH = (
    "docs/artifacts/runs/"
    "20260506T-task-eval-public-fusion-screen-round2/fusion_screen_summary.json"
)
DEFAULT_NASA_PUBLIC_OPT_SUMMARY_PATH = (
    "docs/artifacts/runs/2026-05-06_public-opt-nasa-round1/"
    "public_opt_summary.json"
)
DEFAULT_UAB_PUBLIC_OPT_SUMMARY_PATH = (
    "docs/artifacts/runs/20260508T125651Z-task-eval-public-opt-uab-robust-prior-r1/"
    "public_opt_summary.json"
)
KEEP_STAGE_I_REPORTS = {
    "README.md",
    "task-eval-ablation-support-20260506T120000Z-task-eval-support.md",
    "task-eval-alignment-support-20260506T120000Z-task-eval-support.md",
    "task-eval-anchor-20260506T165435Z-task-eval-anchor.md",
    "task-eval-case-study-phase2-2026-04-29.md",
    "task-eval-causal-support-20260506T120000Z-task-eval-support.md",
    "task-eval-closure-2026-04-30.md",
    "task-eval-deep-comparison-full-loso-2026-05-01.md",
    "task-eval-public-fusion-screen-20260506T-task-eval-public-fusion-screen-round2.md",
    "task-eval-public-mainline-2026-05-08_public-mainline-uab-robust-prior-r1.md",
    "task-eval-public-opt-2026-05-06_public-opt-nasa-round1.md",
    "task-eval-public-opt-20260506T165558Z-task-eval-public-opt-uab-torch-gpu.md",
    "task-eval-public-opt-20260508T090700Z-task-eval-public-opt-uab-heat-specialist-r1.md",
    "task-eval-public-opt-20260508T125651Z-task-eval-public-opt-uab-robust-prior-r1.md",
    "task-eval-runtime-demo-20260506T165435Z-task-eval-runtime-demo.md",
}
...
def run_task_eval_midterm_evidence(
    ...
    with open_task_eval_run_observer(
        ...
        stage_name="task_eval_midterm_evidence",
        logger=LOGGER,
        initial_progress={
        ...
        return _run_task_eval_midterm_evidence_observed(
            config=config,
            run_root=run_root,
            progress=progress,
        )
...
def _run_task_eval_midterm_evidence_observed(
    *,
    config: StageIMidtermEvidenceConfig,
    run_root: Path,
    ...
    cleanup_audit = _build_cleanup_audit(
        ...
        keep_names=KEEP_STAGE_I_REPORTS | {f"task-eval-midterm-{config.run_id}.md"},
    )
    ...
    report_path = report_root / f"task-eval-midterm-{config.run_id}.md"
    report_path.write_text(
        render_task_eval_midterm_report(
            run_id=config.run_id,
            sources=sources,
            font_selection=font_selection,
            metrics_frame=metrics_frame,
...
def _build_cleanup_audit(
    *,
    ...
    report_candidates = []
    task_eval_report_paths = sorted(report_root.glob("*.md"))
    for path in task_eval_report_paths:
        ...
        report_candidates.append(
            {
                ...
                "suggested_archive_path": str(
                    Path("docs/artifacts/runs/archive/public_history") / path.name
                ),
                "reference_hits": hits,
    ...
    coverage_rows = []
    for path in sorted((workspace_root / "src/chronaris/pipelines/task_eval").glob("*.py")):
        module_token = f"chronaris.pipelines.task_eval.{path.stem}"
...
def render_task_eval_midterm_report(
    *,
    run_id: str,
    sources: Mapping[str, Mapping[str, object]],
    ...
    return "\n".join(
        [
            f"# task evaluation Midterm Evidence - {run_id}",
            "",
            "## 1. 总判断",
            "",
