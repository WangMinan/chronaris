"""Readers for feature export exported feature bundles."""
...
class StageHFeatureView:
    """One view-level feature export feature bundle plus manifest metadata."""
...
class StageHFeatureRun:
    """A loaded feature export run with all view-level feature bundles."""
...
def load_feature_export_feature_run(run_manifest_path: str | Path) -> StageHFeatureRun:
    """Load all view feature bundles referenced by a feature export run manifest."""
...
def load_feature_export_feature_view(view_manifest_path: str | Path) -> StageHFeatureView:
    """Load one feature export view feature bundle by its view manifest."""
...
def _load_view(
    *,
    ...
    if missing:
        raise ValueError(f"feature export feature bundle is missing keys: {', '.join(missing)}")
