"""task evaluation baseline pipelines for public benchmark datasets."""
...
from chronaris.modeling.common.baseline_models import (
...
from chronaris.archive.legacy_public_benchmark.baseline_reporting import (
...
class StageIBaselineArtifacts:
    """Machine outputs from one task evaluation baseline run."""
...
def run_task_eval_baselines(
    ...
    *,
    ...
    """Run one task evaluation baseline suite."""
    ...
    raise ValueError(
        f"unsupported task evaluation baseline request: dataset_id={dataset_id}, profile={profile}, task_family={task_family}"
    )
...
def run_uab_baselines(
    ...
    *,
    ...
    """Backwards-compatible wrapper for UAB task evaluation runs."""
    ...
    return run_task_eval_baselines(
        feature_table,
