"""Rendering helpers for task evaluation Phase 3 closure."""
...
def render_task_eval_phase3_report(summary: Mapping[str, object]) -> str:
    """Render the top-level task evaluation Phase 3 closure markdown."""

    lines = [
        "# task evaluation Phase 3 Closure",
        "",
        ...
        "## 收口说明",
        "",
        "- 本轮收口把 task evaluation 主线从 session-level UAB 切换到 window-level UAB，并补齐 NASA CSM attention-state 第二公开数据集。",
