...
def _source_reference_label(path_like: str) -> str:
    path = str(path_like)
    mapping = {
        "stage_i_evidence": "evidence manifest",
        "stage_i_multitask_sweep": "weak-label sweep summary",
        "stage_i_private_leakage_safe_ablation": "private component ablation summary",
        "stage_i_public_adapter_calibration": "public adapter calibration summary",
        "stage_i_public_transfer_boundary": "public transfer boundary summary",
        "stage_i_runtime_service": "runtime service summary and field contract",
        "stage_i_runtime_inference": "runtime replay summary",
        "stage_i_support": "semantic support summary",
        "stage_i_semantic_event_support": "semantic event support summary",
        "stage_i_rotation_audit": "rotation audit summary",
        "stage_i_rigid_body": "rigid-body ablation summary",
        "stage_i_llm_preprocessing": "LLM preprocessing summary",
        "stage_i_llm_comparison": "LLM comparison summary",
        "stage_i_thesis_figures": "runtime semantic case table",
    }
