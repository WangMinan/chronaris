...
from chronaris.pipelines.stage_i.public.opt_data import (
    PUBLIC_OPT_PROFILE,
    build_stage_i_public_opt_feature_frame,
)
from chronaris.pipelines.stage_i.public.opt_reference import (
...
from chronaris.pipelines.stage_i.public.opt_torch_catalog import (
    TorchUABCandidateSpec,
    build_torch_uab_candidates,
    is_better_torch_screen_row,
    validate_torch_uab_config,
)
from chronaris.pipelines.stage_i.public.opt_torch_candidates import (
    _build_feature_profile_bundle,
    _run_torch_uab_candidate,
)
from chronaris.pipelines.stage_i.public.opt_torch_reporting import (
...
from chronaris.pipelines.stage_i.public.opt_torch_selection import (
    _build_torch_uab_full_shortlist_rows,
    _group_metric_or_nan,
    _normalize_torch_uab_selected_subsets,
    _select_final_torch_uab_result,
