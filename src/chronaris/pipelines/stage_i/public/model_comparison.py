"""Build Stage I public model-comparison artifacts for midterm reporting."""
...
CURRENT_NASA_FUSION_SUMMARY = (
    "docs/artifacts/assets/stage_i_midterm_runtime/"
    "20260509T065500Z-stage-i-public-fusion-nasa-full-confirm/"
    "deep_baseline_summary.json"
)
CURRENT_UAB_FUSION_SUMMARY = (
    "docs/artifacts/assets/stage_i/20260506T-uab-public-fusion-confirm/"
    "deep_baseline_summary.json"
)
NASA_PUBLIC_OPT_SUMMARY = (
    "docs/artifacts/assets/stage_i_public_opt/"
    "20260506T161500Z-stage-i-public-opt-nasa-round1/public_opt_summary.json"
)
...
class StageIPublicModelComparisonConfig:
    run_id: str
    artifact_root: str = "docs/artifacts/assets/stage_i_public_model_comparison"
...
def build_stage_i_public_model_comparison(
    ...
    report_path = report_root / f"stage-i-public-model-comparison-{config.run_id}.md"
...
def _render_report(
    ...
    lines = [
        f"# Stage I Public Model Comparison - {run_id}",
        "",
        "## 1. Executive Summary",
        "",
        (
...
def _find_latest_refresh_summary() -> Path | None:
    root = REPO_ROOT / "docs/artifacts/assets/stage_i_public_fusion_refresh"
    if not root.exists():
        return None
