...
def render_stage_i_llm_comparison_report(
    *,
    ...
    """Render the engineering-facing Stage I report."""
    ...
    lines = [
        f"# Stage I LLM Preprocessing Comparison - {summary['run_id']}",
        "",
...
def render_stage_i_llm_midterm_summary(
    *,
    summary: Mapping[str, object],
    condition_manifest: Mapping[str, object],
) -> str:
    ...
    lines = [
        ...
        "",
        (
            "P21 已在现有 Stage I weak-label 与 runtime 证据链上完成 A0-A4 本地对比："
        ...
        (
            ...
            "DeepSeek P20 预处理 context 已通过 P21 对比实验接入 Stage I 证据链："
        ...
        f"- Stage I 工程报告：`{summary['report_path']}`",
    ]
    return "\n".join(lines)
