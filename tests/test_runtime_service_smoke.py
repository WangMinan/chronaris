"""Tests for Stage I runtime/service smoke outputs."""
...
_HELPER_SPEC = importlib.util.spec_from_file_location(
    ...
    Path(__file__).resolve().with_name("test_runtime_inference.py"),
)
...
run_stage_i_multitask_train = _HELPER_MODULE.run_stage_i_multitask_train
