...
from chronaris.serving.runtime_inference import (  # noqa: E402
    ...
    run_task_eval_runtime_inference_batch,
    run_task_eval_runtime_inference_incremental,
...
class StageIRuntimeInferenceTest(unittest.TestCase):
    def test_runtime_inference_loads_checkpoint_and_writes_predictions(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            runtime_result = run_task_eval_runtime_inference(
                StageIRuntimeInferenceConfig(
    ...
    def test_runtime_inference_batch_and_incremental_match_sample_count(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            batch_result = run_task_eval_runtime_inference_batch(
                StageIRuntimeInferenceConfig(
            ...
            incremental_result = run_task_eval_runtime_inference_incremental(
                StageIRuntimeInferenceConfig(
