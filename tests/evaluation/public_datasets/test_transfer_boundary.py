...
from chronaris.evidence.public_transfer_boundary import (  # noqa: E402
    StageIPublicTransferBoundaryConfig,
    run_task_eval_public_transfer_boundary,
)
...
class StageIPublicTransferBoundaryTest(unittest.TestCase):
    def test_public_adapter_calibration_and_transfer_boundary_write_outputs(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            calibration_result = run_task_eval_public_adapter_calibration(
                StageIPublicAdapterCalibrationConfig(
            ...
            boundary_result = run_task_eval_public_transfer_boundary(
                StageIPublicTransferBoundaryConfig(
