"""Tests for the P21 Stage I LLM preprocessing comparison."""
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result = run_stage_i_llm_comparison(
                StageILLMComparisonConfig(
                    run_id="stage-i-llm-comparison-test",
...
def _write_sources(root: Path) -> dict[str, Path]:
    ...
    dump_stage_i_private_task_entries(_task_entries(), path=task_manifest)
