"""Tests for task evaluation thesis weak-label multitask sweep."""
...
_HELPER_SPEC = importlib.util.spec_from_file_location(
    "task_eval_multitask_train_helpers",
    SRC.parent / "tests" / "modeling" / "test_multitask_train.py",
)
...
_ORIGINAL_SWEEP_RUNNER = run_task_eval_multitask_sweep.__globals__["run_task_eval_multitask_train"]
    ...
    def test_multitask_sweep_writes_partial_summary_and_resume_avoids_rerun(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with self.assertRaisesRegex(RuntimeError, "synthetic blocker"), mock.patch(
                "chronaris.evidence.weak_label_sweep.run_task_eval_multitask_train",
            ...
            with mock.patch(
                ...
                resumed_result = run_task_eval_multitask_sweep(
                    StageIMultitaskSweepConfig(
