"""Tests for task evaluation rigid-body rotation audit."""
...
from chronaris.evidence.rigid_body_rotation_audit import (  # noqa: E402
    StageIRigidBodyRotationAuditConfig,
    run_task_eval_rigid_body_rotation_audit,
)
...
class StageIRotationAuditTest(unittest.TestCase):
    def test_rotation_audit_refreshes_yaw_mapping_and_writes_report(self) -> None:
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch(
                "chronaris.evidence.rigid_body_rotation_audit._resolve_vehicle_field_labels",
                return_value=(
                    {
                        "BUS.code1031": "[TSPI数据][载机真航向][_角度_毫弧度]",
                    },
                ...
                result = run_task_eval_rigid_body_rotation_audit(
                    StageIRigidBodyRotationAuditConfig(
            ...
            self.assertTrue(summary["feature_export_feature_rotation_groups"]["yaw"])
