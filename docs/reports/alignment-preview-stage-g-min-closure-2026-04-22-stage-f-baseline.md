...
![Train/Validation Total Loss](assets/alignment-preview-stage-g-min-closure-2026-04-22-stage-f-baseline/train_validation_total_loss.png)

### Train/Validation Alignment Loss

![Train/Validation Alignment Loss](assets/alignment-preview-stage-g-min-closure-2026-04-22-stage-f-baseline/train_validation_alignment_loss.png)

### Per-Stream Reconstruction Loss

![Per-Stream Reconstruction Loss](assets/alignment-preview-stage-g-min-closure-2026-04-22-stage-f-baseline/reconstruction_stream_loss.png)

### Train/Validation Physics Loss

![Train/Validation Physics Loss](assets/alignment-preview-stage-g-min-closure-2026-04-22-stage-f-baseline/train_validation_physics_loss.png)

### Final Physics Constraint Components

![Final Physics Constraint Components](assets/alignment-preview-stage-g-min-closure-2026-04-22-stage-f-baseline/constraint_component_breakdown.png)

### Reference Projection Cosine

![Reference Projection Cosine](assets/alignment-preview-stage-g-min-closure-2026-04-22-stage-f-baseline/reference_projection_cosine.png)
