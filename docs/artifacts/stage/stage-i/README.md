...
Stage I 包含历史公开 benchmark、私有代理任务证据、论文 support、中期证据和 runtime/demo 产物。

入口：

- `reports/`：Stage I Markdown 报告。
- `private-reports/`：私有 benchmark 与 `chronaris_opt` Markdown 报告。
- `assets-stage-i/`：Stage I Phase 0/1/2/3、deep comparison 等机器资产。
- `assets-private/`：私有 benchmark 与 package 机器资产。
