...
| Stage I runtime replay r1 raw samples | `docs/artifacts/assets/stage_i_runtime_inference/20260607T-stage-i-runtime-replay-r1/runtime_samples.jsonl` | 412M | 当前保留 `20260607T-stage-i-runtime-service-r2` summary 与 runtime replay 报告；r1 小型产物已在后续深度清理中移除 |
| Stage I runtime service r1 raw input | `docs/artifacts/assets/stage_i_runtime_service/20260613T-stage-i-runtime-service-smoke-r1/input_view_runtime_samples.jsonl` | 138M | 当前保留 `20260613T-stage-i-runtime-service-smoke-r2-contract` schema contract、canonical runtime summary 与 r2 contract report；r1 小型产物已在后续深度清理中移除 |
