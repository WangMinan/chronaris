...
- state dim: `32`
- fused dim: `96`
- use causal mask: `True`
- lag window points: `None`
- fusion output mode: `concat`
- residual mode: `none`
- mean attention entropy: `0.932071`
- mean max attention: `0.224872`
...
| --- | ---: | ---: | ---: | ---: |
| `20251005_四01_ACT-4_云_J20_22#01:0020` | 4.333333 | 1.000000 | 0.333333 | 2.597950 |
| `20251005_四01_ACT-4_云_J20_22#01:0021` | 4.333333 | 1.000000 | 0.333333 | 2.597950 |
| `20251005_四01_ACT-4_云_J20_22#01:0022` | 4.333333 | 1.000000 | 0.333333 | 2.597950 |

### Semantic Event Fusion

- query names: `['risk_proxy', 'workload_proxy', 'event_replay_tag']`
...
| --- | --- | ---: | ---: |
| `20251005_四01_ACT-4_云_J20_22#01:0020` | risk_weak_label | 0.742916 | 7.793849 |
| `20251005_四01_ACT-4_云_J20_22#01:0021` | risk_weak_label | 0.742916 | 7.793849 |
| `20251005_四01_ACT-4_云_J20_22#01:0022` | risk_weak_label | 0.742916 | 7.793849 |

### Stage G Artifacts

- summary json: `/home/wangminan/projects/chronaris/docs/artifacts/stage_i/assets/stage-i-semantic-event-20260607T-stage-i-semantic-event-r1/causal_fusion_summary.json`
- samples csv: `/home/wangminan/projects/chronaris/docs/artifacts/stage_i/assets/stage-i-semantic-event-20260607T-stage-i-semantic-event-r1/causal_fusion_samples.csv`

#### Causal Attention Heatmap

![Causal Attention Heatmap](assets/stage-i-semantic-event-20260607T-stage-i-semantic-event-r1/causal_attention_heatmap.png)
...
![Train/Validation Total Loss](assets/stage-i-semantic-event-20260607T-stage-i-semantic-event-r1/train_validation_total_loss.png)

### Train/Validation Alignment Loss

![Train/Validation Alignment Loss](assets/stage-i-semantic-event-20260607T-stage-i-semantic-event-r1/train_validation_alignment_loss.png)

### Per-Stream Reconstruction Loss

![Per-Stream Reconstruction Loss](assets/stage-i-semantic-event-20260607T-stage-i-semantic-event-r1/reconstruction_stream_loss.png)

### Train/Validation Physics Loss

![Train/Validation Physics Loss](assets/stage-i-semantic-event-20260607T-stage-i-semantic-event-r1/train_validation_physics_loss.png)

### Final Physics Constraint Components

![Final Physics Constraint Components](assets/stage-i-semantic-event-20260607T-stage-i-semantic-event-r1/constraint_component_breakdown.png)

### Reference Projection Cosine

![Reference Projection Cosine](assets/stage-i-semantic-event-20260607T-stage-i-semantic-event-r1/reference_projection_cosine.png)
