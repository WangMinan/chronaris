# Stage I Thesis Weak-Label Multitask Sweep - 20260613T-stage-i-p11-live-influx-r3-resume
...
- combination_count: `2`
- derived_from_run_id: `20260613T-stage-i-p11-live-influx-r3-resume`
- blocked_at_run_index: `3`
- blocked_attempt_log_paths: `['docs/artifacts/assets/stage_i_multitask_sweep/20260613T-stage-i-p11-live-influx-r1/run.log']`
...
- child_run_id: `20260613T-stage-i-p11-live-influx-r1-01-minimal-cw0p00-tlw0p50-lagnone`
- physics_constraint_family: `minimal`
- test_total: `1153.8985701851223`
- checkpoint_path: `docs/artifacts/assets/stage_i_multitask_sweep/20260613T-stage-i-p11-live-influx-r1/runs/20260613T-stage-i-p11-live-influx-r1-01-minimal-cw0p00-tlw0p50-lagnone/multitask_checkpoint.pt`
