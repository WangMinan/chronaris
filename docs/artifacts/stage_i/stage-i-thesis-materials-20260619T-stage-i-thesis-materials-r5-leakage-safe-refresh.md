...
- `chronaris_opt_component_ablation`: `docs/artifacts/assets/stage_i_thesis_figures/20260619T-stage-i-thesis-materials-r5-leakage-safe-refresh/chronaris_opt_component_ablation.csv` (`36` rows, `36` columns)
- `model_backbone_ablation`: `docs/artifacts/assets/stage_i_thesis_figures/20260619T-stage-i-thesis-materials-r5-leakage-safe-refresh/model_backbone_ablation.csv` (`18` rows, `36` columns)
- `task_adapter_ablation`: `docs/artifacts/assets/stage_i_thesis_figures/20260619T-stage-i-thesis-materials-r5-leakage-safe-refresh/task_adapter_ablation.csv` (`18` rows, `36` columns)
