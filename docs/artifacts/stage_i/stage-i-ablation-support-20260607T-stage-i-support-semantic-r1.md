# Stage I Ablation Support - 20260607T-stage-i-support-semantic-r1
...
- main_ablation_matrix: `/home/wangminan/projects/chronaris/docs/artifacts/assets/stage_i_support/20260607T-stage-i-support-semantic-r1/ablation_matrix.csv`
- overview_plot: `/home/wangminan/projects/chronaris/docs/artifacts/assets/stage_i_support/20260607T-stage-i-support-semantic-r1/support_overview.png`
...
| `G(min)` | `causal_fusion_summary + phase2_case_study` | 3.0 | 0.705586 | 0.101908 | 3.0 | 0.930686 | 1.000000 | 2.399792 | +0.000000 | - | - | - | 非对称注意力与双 pilot 差异可读 | 不等价于任务级 superiority |
