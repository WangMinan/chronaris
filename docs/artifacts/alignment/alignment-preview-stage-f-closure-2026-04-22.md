...
- 细粒度证据保留在 `docs/artifacts/assets/alignment-preview-stage-f-closure-2026-04-22-e-baseline/` 与 `docs/artifacts/assets/alignment-preview-stage-f-closure-2026-04-22-stage-f-full/`。
