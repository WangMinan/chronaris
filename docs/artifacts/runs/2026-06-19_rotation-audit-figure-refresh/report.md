# task evaluation Rigid-Body Rotation Audit - 20260619T-task-eval-rotation-audit-r3-figure-refresh
...
3. 当前 feature export 缺口：`{'rotation': ['pitch/pitch_rate', 'roll/roll_rate', 'yaw/yaw_rate']}`。
