# task evaluation Ablation Support - 20260607T-task-eval-support-semantic-r2
...
- main_ablation_matrix: `/home/wangminan/projects/chronaris/docs/artifacts/runs/2026-06-07_semantic-support/ablation_matrix.csv`
- overview_plot: `/home/wangminan/projects/chronaris/docs/artifacts/runs/2026-06-07_semantic-support/support_overview.png`
...
| `F(full)` | `projection_diagnostics_summary + feature_export_run_manifest` | 3.0 | 0.699514 | 0.212016 | 3.0 | - | - | - | - | - | - | - | 稳定导出与双 pilot 可读性 | 不直接给出因果 ablation 胜负 |
...
| `vehicle_delta_suppressed` | `phase2_case_study_bundle_only` | 3.0 | 0.705586 | 0.101908 | 3.0 | 0.937500 | 0.000000 | 0.000000 | -2.399792 | - | - | - | 事件/机动敏感性可读 | 仅是 frozen feature export view 上的 bundle-only 干预 |
| `no_event_bias` | `phase2_case_study_bundle_only` | 3.0 | 0.705586 | 0.101908 | 3.0 | 0.932829 | 1.000000 | 2.126160 | -0.273633 | - | - | - | 事件/机动敏感性可读 | 仅是 frozen feature export view 上的 bundle-only 干预 |
