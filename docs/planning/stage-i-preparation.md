...
1. Stage H 现有实飞资产
    使用 artifacts/stage_h/20260427T000000Z-stage-h-closure/run_manifest.json，通过 src/chronaris/features/stage_h_bundle.py:1 读取 3 个真实双流 view。它只做案例复盘、注意力解释、掩码干扰实验，不拿来做大规模监督训练。
