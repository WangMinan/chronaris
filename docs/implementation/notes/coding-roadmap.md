...
`阶段 A/B/C 已完成，阶段 E0 已完成 preview 路径，阶段 E/F/G(min) 已完成，阶段 H 已完成收口，阶段 I 的历史公开 benchmark 收口已完成；当前进入“Stage I 论文主线重构”阶段`
...
- [AGENTS.md](../../../AGENTS.md)
- [architecture.md](../../requirements/foundation/architecture.md)
- [data-contracts.md](../../requirements/foundation/data-contracts.md)
- [pipeline-v1.md](../../requirements/foundation/pipeline-v1.md)
...
当前主线已经从“扩大公开 benchmark”切换为“Stage I 论文主线重构”。现行入口统一为：

1. [stage-i-thesis-mainline-roadmap-2026-05-15.md](stage-i-thesis-mainline-roadmap-2026-05-15.md)
...
1. 不继续扩大 `UAB torch / sklearn` 候选扩搜。
2. 不把 `UAB robust-prior adapter` 写成双流融合本体胜利。
3. 不把 `T1/T2/T3 proxy benchmark` 直接写成人工真值 thesis task。
4. 不把 `runtime_demo.py` 包装成实时推理引擎。
5. 不删除 `E/F/G/H` 收口工件；它们仍是历史基线与导出依赖。
6. 不把 `20251110...` vehicle-only partial bundle 误提升为双流 Stage H view。
