...
共同评价的当前代码接口、监督分层和开发验收方式见[可执行合同 v1](common-downstream-executable-contract-v1.md)。本轮已授权[阶段 4.5-B](thesis-stage45b-development-20260921.md)：在原共同任务下检验训练内分组选模与分支信息保留，标签辅助选模单独声明；阶段 5 仍待后续研究判断。
