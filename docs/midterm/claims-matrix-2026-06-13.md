...
| P16/P18/P25 已产出中期说明图表 | 强 | thesis_materials | `docs/artifacts/assets/stage_i_thesis_figures/20260619T-stage-i-thesis-materials-r5-leakage-safe-refresh/figure_manifest.json`; `stage-i-thesis-materials-20260619T-stage-i-thesis-materials-r5-leakage-safe-refresh.md` | 图表覆盖所有可能实验；r5 图表证明 LLM/rotation/runtime 已突破当前数据边界 |
