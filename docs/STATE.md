...
- 仿真压力主线：3 seeds × 35 场景 × 6 方法共 630 份 `[192,96,64]` 表示全部完成，5/5 门禁通过；冻结 consumer 已完成 59/105 个种子—场景单元，推进至随机缺失 10% 场景。消融表示完成后已从逐场景恢复点自动续跑，与鼎新 GPU 主训练保持两作业并行上限。
