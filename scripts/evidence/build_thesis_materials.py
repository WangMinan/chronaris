#!/usr/bin/env python3
"""Build task evaluation thesis tables and explanatory figures from stable artifacts."""
...
from chronaris.evidence.thesis_materials import (  # noqa: E402
    StageIThesisMaterialsConfig,
    run_task_eval_thesis_materials,
)
...
def main() -> None:
    ...
    result = run_task_eval_thesis_materials(config)
