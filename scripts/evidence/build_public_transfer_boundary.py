"""Build task evaluation public transfer-boundary report."""
...
def _default_run_id() -> str:
    return datetime.now(timezone.utc).strftime("%Y%m%dT%H%M%SZ-task-eval-public-transfer-boundary")
...
def main() -> int:
    args = parse_args()
    result = run_task_eval_public_transfer_boundary(
        StageIPublicTransferBoundaryConfig(
            run_id=args.run_id,
