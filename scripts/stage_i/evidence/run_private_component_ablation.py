"""Run Stage I private proxy component ablation over real Stage H assets."""
...
def _default_run_id() -> str:
    return datetime.now(timezone.utc).strftime("%Y%m%dT%H%M%SZ-stage-i-private-component-ablation")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-root", default="docs/artifacts/assets/stage_i_private_component_ablation")
