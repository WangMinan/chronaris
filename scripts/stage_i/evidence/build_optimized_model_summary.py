"""Build the Stage I optimized model summary package."""
...
from chronaris.pipelines.stage_i.evidence.optimized_model_summary import (  # noqa: E402
    StageIOptimizedModelSummaryConfig,
    run_stage_i_optimized_model_summary,
)


def _default_run_id() -> str:
    return datetime.now(timezone.utc).strftime("%Y%m%dT%H%M%SZ-stage-i-optimized-model-summary")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--artifact-root", default="docs/artifacts/assets/stage_i_optimized_model_summary")
...
def main() -> int:
    ...
    result = run_stage_i_optimized_model_summary(
        StageIOptimizedModelSummaryConfig(
            run_id=args.run_id,
