"""Build the Stage I midterm evidence pack from verified Stage I artifacts."""
...
from chronaris.pipelines.stage_i.stage_i_midterm_evidence import (  # noqa: E402
...
def _default_run_id() -> str:
    return datetime.now(timezone.utc).strftime("%Y%m%dT%H%M%SZ-stage-i-midterm")
