#!/usr/bin/env python3
"""Run five-fold Dingxin confirmation for the G1-selected encoder configs."""
...
def main() -> int:
    ...
    parser.add_argument("--run-id", default="2026-07-11_dingxin-selected-validation-seed17")
    ...
    result = run_dingxin_selected_screen(
        DingxinSelectedScreenConfig(
            run_id=args.run_id,
