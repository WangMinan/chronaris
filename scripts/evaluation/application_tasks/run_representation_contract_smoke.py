"""Run the unified Dingxin/simulation representation contract smoke."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--run-id",
        default="2026-07-11_representation-contract-smoke",
    )
...
def main() -> int:
    ...
    args = parse_args()
    result = run_representation_contract_smoke(
        RepresentationContractSmokeConfig(
            run_id=args.run_id,
