#!/usr/bin/env python3
"""Run the locked multi-seed G1 Chronaris mechanism ablations."""
...
def main() -> int:
    ...
    parser.add_argument("--run-id", default="2026-07-12_simulation-chronaris-ablation-pretraining")
    ...
    result = run_simulation_chronaris_ablation_pretraining(
        SimulationChronarisAblationPretrainingConfig(
            run_id=args.run_id,
