#!/usr/bin/env python3
"""Run resumable multi-seed G1 retraining of the selected encoders."""
...
def main() -> int:
    ...
    parser.add_argument("--run-id", default="2026-07-12_simulation-locked-pretraining")
    ...
    result = run_simulation_locked_pretraining(
        SimulationLockedPretrainingConfig(
            run_id=args.run_id,
