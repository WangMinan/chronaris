#!/usr/bin/env python3
"""Build inner-train-fitted Dingxin task targets."""
...
def main() -> int:
    ...
    parser.add_argument("--run-id", default="2026-07-11_dingxin-nested-targets")
    args = parser.parse_args()
    configure_task_eval_cli_logging(sys.stderr)
    result = run_dingxin_nested_targets(DingxinNestedTargetConfig(run_id=args.run_id))
