"""Run the GPU-first torch-native UAB regression branch for task evaluation public opt."""
...
def _default_run_id() -> str:
    return datetime.now(timezone.utc).strftime("%Y%m%dT%H%M%SZ-task-eval-public-opt-uab-torch")
