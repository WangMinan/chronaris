"""Build the unified task evaluation public-mainline report from existing artifacts."""
...
def _default_run_id() -> str:
    return datetime.now(timezone.utc).strftime("%Y%m%dT%H%M%SZ-task-eval-public-mainline")
