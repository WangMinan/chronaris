...
from chronaris.evaluation.public_datasets.pipelines.fusion_gpuopt import (  # noqa: E402
    StageIPublicFusionGPUOptConfig,
    run_task_eval_public_fusion_gpuopt,
)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--run-id",
        default="20260701T-task-eval-public-fusion-refresh-r1-gpuopt-r1",
    )
    parser.add_argument("--base-p28-run-id", default="20260701T-task-eval-public-fusion-refresh-r1")
    parser.add_argument(
        "--base-p28-root",
        default=(
            "docs/artifacts/runs/"
...
def main() -> int:
    ...
    args = parse_args()
    result = run_task_eval_public_fusion_gpuopt(
        StageIPublicFusionGPUOptConfig(
            run_id=args.run_id,
