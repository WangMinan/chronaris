"""Run the task evaluation leakage-safe private proxy ablation protocol."""
...
def _default_run_id() -> str:
    return datetime.now(timezone.utc).strftime("%Y%m%dT%H%M%SZ-task-eval-leakage-safe-ablation")
