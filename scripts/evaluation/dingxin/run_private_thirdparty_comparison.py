"""Run P30 private feature export Chronaris vs MulT/ContiFormer comparison."""
...
from chronaris.evaluation.dingxin.pipelines.thirdparty_comparison import (  # noqa: E402
    MODEL_ORDER,
...
def _default_run_id() -> str:
    return datetime.now(timezone.utc).strftime("%Y%m%dT%H%M%SZ-task-eval-private-thirdparty-comparison")
...
def main() -> int:
    ...
    if args.resume_run_id:
        ...
        args.resume = True
    result = run_task_eval_private_thirdparty_comparison(
        StageIPrivateThirdPartyComparisonConfig(
            run_id=args.run_id,
